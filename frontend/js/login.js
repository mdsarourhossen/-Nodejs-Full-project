...
const errorEliment =document.getElementById('user-login-error');
//user data did not match  with database
if(userInfo.length===0){
errorEliment.classList.remove('hidden');

}
else{

errorEliment.classList.add('hidden');
//server  user information befor jumping to next page
